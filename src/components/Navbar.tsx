...
export default function Navbar() {
  ...
  return (
    <div className="mx-auto flex  w-full max-w-7xl justify-between px-4 py-5 text-sm bg-gray-700">
      {/* left side  */}
      ...
      <section className=" hidden md:flex   items-center gap-8 ">
        ...
        <Link
          href={
            "https://www.facebook.com/share/he8Z43afdSuAkFn1/?mibextid=qi2Omg"
          }
          target="_blank"
...
function MobileNav({ closeSideMenu }: { closeSideMenu: () => void }) {
  return (
    <div className="fixed left-0 top-0 flex h-full min-h-screen w-[90%] justify-end bg-black/60 md:hidden">
      <div className=" h-full w-[60%] bg-white px-4 py-4">
        ...
        <section className="  flex  flex-col   gap-8  mt-4 items-center">
          ...
          <Link
            ...
            target="_blank"
            className="w-[65%]  max-w-[150px]  rounded-xl border-2 border-neutral-400 px-4 py-2 text-neutral-400 transition-all hover:border-black hover:text-black/90"
          >
            FaceBook
          </Link>
        </section>
